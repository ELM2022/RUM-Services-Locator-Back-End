...
const emailConfirmRegister = async(email) => { // create confirmation link/route?
    try {
        ...
        const text = `Su cuenta de administrador (${email}) ha sido registrada al sistema de 'RUM Services Locator'.\nPuede acceder al sistema e iniciar sesión con sus credenciales.`;
